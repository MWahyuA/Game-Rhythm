...
public class NoteObjectStyle : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(keyToPress))
        {
            ...
            if (canBePressed)
            {
                ...
                {
                    Debug.Log("Hit");
                    GameManagerStyle.instance.NormalHit();
                ...
                {
                    Debug.Log("Good");
                    GameManagerStyle.instance.GoodHit();
                ...
                {
                    Debug.Log("Great");
                    GameManagerStyle.instance.GreatHit();
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            canBePressed = false;
            GameManagerStyle.instance.NoteMissed();
            Instantiate(badEffect, transform.position, badEffect.transform.rotation);
            Miss.Play();
            HealthManagerStyle.instance.Damage(1);
            cekMiss = true;
        }
