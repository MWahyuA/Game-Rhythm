...
public class NoteObjectSipatokaan : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(keyToPress))
        {
            ...
            if (canBePressed)
            {
                ...
                {
                    Debug.Log("Hit");
                    GameManagerSipatokaan.instance.NormalHit();
                ...
                {
                    Debug.Log("Good");
                    GameManagerSipatokaan.instance.GoodHit();
                ...
                {
                    Debug.Log("Great");
                    GameManagerSipatokaan.instance.GreatHit();
        ...
        } else
        {
          ...
          if(scale)
            ...
            if (button4)
            {
                transform.position -= new Vector3(0.50f * Time.deltaTime, 0f, 0f);
            }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            canBePressed = false;
            GameManagerSipatokaan.instance.NoteMissed();
            Instantiate(badEffect, transform.position, badEffect.transform.rotation);
            Miss.Play();
            HealthManagerSipatokaan.instance.Damage(1);
            cekMiss = true;
        }
