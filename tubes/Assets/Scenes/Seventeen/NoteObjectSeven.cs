...
public class NoteObjectSeven : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(keyToPress))
        {
            ...
            if (canBePressed)
            {
                ...
                {
                    Debug.Log("Hit");
                    GameManagerSeven.instance.NormalHit();
                ...
                {
                    Debug.Log("Good");
                    GameManagerSeven.instance.GoodHit();
                ...
                {
                    Debug.Log("Great");
                    GameManagerSeven.instance.GreatHit();
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            canBePressed = false;
            GameManagerSeven.instance.NoteMissed();
            Instantiate(badEffect, transform.position, badEffect.transform.rotation);
            Miss.Play();
            HealthManagerSeven.instance.Damage(1);
            cekMiss = true;
        }
