...
public class NoteObjectIndo : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(keyToPress))
        {
            ...
            if (canBePressed)
            {
                ...
                {
                    Debug.Log("Hit");
                    GameManagerIndo.instance.NormalHit();
                ...
                {
                    Debug.Log("Good");
                    GameManagerIndo.instance.GoodHit();
                ...
                {
                    Debug.Log("Great");
                    GameManagerIndo.instance.GreatHit();
        ...
        } else
        {
          ...
          if(scale)
            ...
            if (button4)
            {
                transform.position -= new Vector3(0.43f * Time.deltaTime, 0f, 0f);
            }

            if (button3)
            {
                transform.position -= new Vector3(0.12f * Time.deltaTime, 0f, 0f);
            }
            ...
            if (button1)
            {
                transform.position += new Vector3(0.39f * Time.deltaTime, 0f, 0f);
            }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            canBePressed = false;
            GameManagerIndo.instance.NoteMissed();
            Instantiate(badEffect, transform.position, badEffect.transform.rotation);
            Miss.Play();
            HealthManagerIndo.instance.Damage(1);
            cekMiss = true;
        }
