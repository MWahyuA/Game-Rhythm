...
public class NoteObjectGundul : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(keyToPress))
        {
            ...
            if (canBePressed)
            {
                ...
                {
                    Debug.Log("Hit");
                    GameManagerGundul.instance.NormalHit();
                ...
                {
                    Debug.Log("Good");
                    GameManagerGundul.instance.GoodHit();
                ...
                {
                    Debug.Log("Great");
                    GameManagerGundul.instance.GreatHit();
        ...
        } else
        {
          ...
          if(scale)
            ...
            if (button4)
            {
                transform.position -= new Vector3(0.47f * Time.deltaTime, 0f, 0f);
            }
            ...
            if (button1)
            {
                transform.position += new Vector3(0.44f * Time.deltaTime, 0f, 0f);
            }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            canBePressed = false;
            GameManagerGundul.instance.NoteMissed();
            Instantiate(badEffect, transform.position, badEffect.transform.rotation);
            Miss.Play();
            HealthManagerGundul.instance.Damage(1);
            cekMiss = true;
        }
