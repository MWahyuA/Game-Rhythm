...
public class NoteObjectKurenai : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(keyToPress))
        {
            ...
            if (canBePressed)
            {
                ...
                {
                    Debug.Log("Hit");
                    GameManagerKurenai.instance.NormalHit();
                ...
                {
                    Debug.Log("Good");
                    GameManagerKurenai.instance.GoodHit();
                ...
                {
                    Debug.Log("Great");
                    GameManagerKurenai.instance.GreatHit();
        ...
        } else
        {
          ...
          if(scale)
            ...
            if (button4)
            {
                transform.position -= new Vector3(0.58f * Time.deltaTime, 0f, 0f);
            }

            if (button3)
            {
                transform.position -= new Vector3(0.17f * Time.deltaTime, 0f, 0f);
            }

            if (button2)
            {
                transform.position += new Vector3(0.20f * Time.deltaTime, 0f, 0f);
            }

            if (button1)
            {
                transform.position += new Vector3(0.54f * Time.deltaTime, 0f, 0f);
            }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            canBePressed = false;
            GameManagerKurenai.instance.NoteMissed();
            Instantiate(badEffect, transform.position, badEffect.transform.rotation);
            Miss.Play();
            HealthManagerKurenai.instance.Damage(1);
            cekMiss = true;
        }
